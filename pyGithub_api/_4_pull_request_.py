...
project_list = ['PyGithub/PyGithub',  'YuriyGamiy/dj_start']
...
def extract_project_PRs(project_full_name):
    ...
    while True:
        try:
            #                                              per_page=100 вернет колличество запросов на странице, можно менять
            ...
            continue
        break
    df_PRs.to_csv('../_2_Dataset/PRs_dataset_5.csv', sep=',', encoding='utf-8', index=True)

extract_project_PRs('PyGithub/PyGithub')